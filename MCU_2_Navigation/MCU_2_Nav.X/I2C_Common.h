...
#ifndef _I2C_COMMON_H    /* Guard against multiple inclusion */
...
// PIC32MK references to useful I2C registers
typedef struct {
    I2CxCONbits_t       * I2CxCONbits;
    I2CxSTATbits_t      * I2CxSTATbits;
    I2CxBRGbits_t       * I2CxBRGbits;
    volatile uint32_t            * I2CxCON;
    volatile uint32_t            * I2CxCONSET;
    volatile uint32_t            * I2CxCONCLR;
    volatile uint32_t            * I2CxTRN;
    volatile uint32_t            * I2CxSTAT;
...
#define _I2CCON_SEN_POSITION                    _I2C1CON_SEN_POSITION
#define _I2CCON_SEN_MASK                        _I2C1CON_SEN_MASK
#define _I2CCON_SEN_LENGTH                      _I2C1CON_SEN_MASK

#define _I2CCON_RSEN_POSITION                   _I2C1CON_RSEN_POSITION
#define _I2CCON_RSEN_MASK                       _I2C1CON_RSEN_MASK
#define _I2CCON_RSEN_LENGTH                     _I2C1CON_RSEN_LENGTH

#define _I2CCON_PEN_POSITION                    _I2C1CON_PEN_POSITION
#define _I2CCON_PEN_MASK                        _I2C1CON_PEN_MASK
#define _I2CCON_PEN_LENGTH                      _I2C1CON_PEN_LENGTH

#define _I2CCON_RCEN_POSITION                   _I2C1CON_RCEN_POSITION
#define _I2CCON_RCEN_MASK                       _I2C1CON_RCEN_MASK
#define _I2CCON_RCEN_LENGTH                     _I2C1CON_RCEN_LENGTH

#define _I2CCON_ACKEN_POSITION                  _I2C1CON_ACKEN_POSITION
#define _I2CCON_ACKEN_MASK                      _I2C1CON_ACKEN_MASK
#define _I2CCON_ACKEN_LENGTH                    _I2C1CON_ACKEN_LENGTH

#define _I2CCON_ACKDT_POSITION                  _I2C1CON_ACKDT_POSITION
#define _I2CCON_ACKDT_MASK                      _I2C1CON_ACKDT_MASK
#define _I2CCON_ACKDT_LENGTH                    _I2CCON_ACKDT_LENGTH

#define _I2CCON_STREN_POSITION                  _I2C1CON_STREN_POSITION
#define _I2CCON_STREN_MASK                      _I2C1CON_STREN_MASK
#define _I2CCON_STREN_LENGTH                    _I2C1CON_STREN_LENGTH

#define _I2CCON_GCEN_POSITION                   _I2C1CON_GCEN_POSITION
#define _I2CCON_GCEN_MASK                       _I2C1CON_GCEN_MASK
#define _I2CCON_GCEN_LENGTH                     _I2C1CON_GCEN_LENGTH

#define _I2CCON_SMEN_POSITION                   _I2C1CON_SMEN_POSITION
#define _I2CCON_SMEN_MASK                       _I2C1CON_SMEN_MASK
#define _I2CCON_SMEN_LENGTH                     _I2C1CON_SMEN_LENGTH

#define _I2CCON_DISSLW_POSITION                 _I2C1CON_DISSLW_POSITION
#define _I2CCON_DISSLW_MASK                     _I2C1CON_DISSLW_MASK
#define _I2CCON_DISSLW_LENGTH                   _I2C1CON_DISSLW_LENGTH

#define _I2CCON_A10M_POSITION                   _I2C1CON_A10M_POSITION
#define _I2CCON_A10M_MASK                       _I2C1CON_A10M_MASK
#define _I2CCON_A10M_LENGTH                     _I2C1CON_A10M_LENGTH

#define _I2CCON_STRICT_POSITION                 _I2C1CON_STRICT_POSITION
#define _I2CCON_STRICT_MASK                     _I2C1CON_STRICT_MASK
#define _I2CCON_STRICT_LENGTH                   _I2C1CON_STRICT_LENGTH

#define _I2CCON_SCLREL_POSITION                 _I2C1CON_SCLREL_POSITION
#define _I2CCON_SCLREL_MASK                     _I2C1CON_SCLREL_MASK
#define _I2CCON_SCLREL_LENGTH                   _I2C1CON_SCLREL_LENGTH

#define _I2CCON_SIDL_POSITION                   _I2C1CON_SIDL_POSITION
#define _I2CCON_SIDL_MASK                       _I2C1CON_SIDL_MASK
#define _I2CCON_SIDL_LENGTH                     _I2C1CON_SIDL_LENGTH

#define _I2CCON_ON_POSITION                     _I2C1CON_ON_POSITION
#define _I2CCON_ON_MASK                         _I2C1CON_ON_MASK
#define _I2CCON_ON_LENGTH                       _I2C1CON_ON_LENGTH

#define _I2CCON_IPMIEN_POSITION                 _I2C1CON_IPMIEN_POSITION
#define _I2CCON_IPMIEN_MASK                     _I2C1CON_IPMIEN_MASK
#define _I2CCON_IPMIEN_LENGTH                   _I2C1CON_IPMIEN_LENGTH

#define _I2CCON_I2CSIDL_POSITION                _I2C1CON_I2CSIDL_POSITION
#define _I2CCON_I2CSIDL_MASK                    _I2C1CON_I2CSIDL_MASK
#define _I2CCON_I2CSIDL_LENGTH                  _I2C1CON_I2CSIDL_LENGTH

#define _I2CCON_I2CEN_POSITION                  _I2C1CON_I2CEN_POSITION
#define _I2CCON_I2CEN_MASK                      _I2C1CON_I2CEN_MASK
#define _I2CCON_I2CEN_LENGTH                    _I2C1CON_I2CEN_LENGTH

#define _I2CCON_w_POSITION                      _I2C1CON_w_POSITION
#define _I2CCON_w_MASK                          _I2C1CON_w_MASK
#define _I2CCON_w_LENGTH                        _I2C1CON_w_LENGTH

#define _I2CSTAT_TBF_POSITION                   _I2C1STAT_TBF_POSITION
#define _I2CSTAT_TBF_MASK                       _I2C1STAT_TBF_MASK
#define _I2CSTAT_TBF_LENGTH                     _I2C1STAT_TBF_LENGTH

#define _I2CSTAT_RBF_POSITION                   _I2C1STAT_RBF_POSITION
#define _I2CSTAT_RBF_MASK                       _I2C1STAT_RBF_MASK
#define _I2CSTAT_RBF_LENGTH                     _I2C1STAT_RBF_LENGTH

#define _I2CSTAT_R_W_POSITION                   _I2C1STAT_R_W_POSITION
#define _I2CSTAT_R_W_MASK                       _I2C1STAT_R_W_MASK
#define _I2CSTAT_R_W_LENGTH                     _I2C1STAT_R_W_LENGTH

#define _I2CSTAT_S_POSITION                     _I2C1STAT_S_POSITION
#define _I2CSTAT_S_MASK                         _I2C1STAT_S_MASK
#define _I2CSTAT_S_LENGTH                       _I2C1STAT_S_LENGTH

#define _I2CSTAT_P_POSITION                     _I2C1STAT_P_POSITION
#define _I2CSTAT_P_MASK                         _I2C1STAT_P_MASK
#define _I2CSTAT_P_LENGTH                       _I2C1STAT_P_LENGTH

#define _I2CSTAT_D_A_POSITION                   _I2C1STAT_D_A_POSITION
#define _I2CSTAT_D_A_MASK                       _I2C1STAT_D_A_MASK
#define _I2CSTAT_D_A_LENGTH                     _I2C1STAT_D_A_LENGTH

#define _I2CSTAT_I2COV_POSITION                 _I2C1STAT_I2COV_POSITION
#define _I2CSTAT_I2COV_MASK                     _I2C1STAT_I2COV_MASK
#define _I2CSTAT_I2COV_LENGTH                   _I2C1STAT_I2COV_LENGTH

#define _I2CSTAT_IWCOL_POSITION                 _I2C1STAT_IWCOL_POSITION
#define _I2CSTAT_IWCOL_MASK                     _I2C1STAT_IWCOL_MASK
#define _I2CSTAT_IWCOL_LENGTH                   _I2C1STAT_IWCOL_LENGTH

#define _I2CSTAT_ADD10_POSITION                 _I2C1STAT_ADD10_POSITION
#define _I2CSTAT_ADD10_MASK                     _I2C1STAT_ADD10_MASK
#define _I2CSTAT_ADD10_LENGTH                   _I2C1STAT_ADD10_LENGTH

#define _I2CSTAT_GCSTAT_POSITION                _I2C1STAT_GCSTAT_POSITION
#define _I2CSTAT_GCSTAT_MASK                    _I2C1STAT_GCSTAT_MASK
#define _I2CSTAT_GCSTAT_LENGTH                  _I2C1STAT_GCSTAT_LENGTH

#define _I2CSTAT_BCL_POSITION                   _I2C1STAT_BCL_POSITION
#define _I2CSTAT_BCL_MASK                       _I2C1STAT_BCL_MASK
#define _I2CSTAT_BCL_LENGTH                     _I2C1STAT_BCL_LENGTH

#define _I2CSTAT_TRSTAT_POSITION                _I2C1STAT_TRSTAT_POSITION
#define _I2CSTAT_TRSTAT_MASK                    _I2C1STAT_TRSTAT_MASK
#define _I2CSTAT_TRSTAT_LENGTH                  _I2C1STAT_TRSTAT_LENGTH

#define _I2CSTAT_ACKSTAT_POSITION               _I2C1STAT_ACKSTAT_POSITION
#define _I2CSTAT_ACKSTAT_MASK                   _I2C1STAT_ACKSTAT_MASK
#define _I2CSTAT_ACKSTAT_LENGTH                 _I2C1STAT_ACKSTAT_LENGTH

#define _I2CSTAT_I2CPOV_POSITION                _I2C1STAT_I2CPOV_POSITION
#define _I2CSTAT_I2CPOV_MASK                    _I2C1STAT_I2CPOV_MASK
#define _I2CSTAT_I2CPOV_LENGTH                  _I2C1STAT_I2CPOV_LENGTH

#define _I2CSTAT_w_POSITION                     _I2C1STAT_w_POSITION
#define _I2CSTAT_w_MASK                         _I2C1STAT_w_MASK
#define _I2CSTAT_w_LENGTH                       _I2C1STAT_w_LENGTH
...
void I2CConfigure ( I2C * i2cObj, I2C_CONFIGURATION flags );
...
I2C_STATUS I2CGetStatus ( I2C * i2cObj );
...
void I2CClearStatus (I2C * i2cObj, I2C_STATUS status );
